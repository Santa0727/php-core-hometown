...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-88V0S00Y88"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-88V0S00Y88');
</script>
</head>
...
<div class="menu-middle-links">
    <div class="container">
        <div class="row row-table">
            <div class="col-md-2 col-table text-center-m logo-m">
                <a href="<?php echo tlink( 'index' ); ?>">
                    <img src="<?php echo site_logo( THEME_LOCATION . '/assets/img/logo.png' ); ?>" alt="" />
                </a>
            </div>
            <div class="col-md-6 col-table text-right text-center-m search-m">
                <div class="search-header">
                    <i class="fa fa-search"></i>
                    <input type="text" placeholder="<?php echo t( 'theme_search_for_coupons', 'Search for coupons ...' ); ?>" class="header-search" />
                </div>
            </div>
            <div class="col-md-8 dnone-m text-right">
                <div class="h-links">
                <?php if( ( $me = me() ) ) { ?>
