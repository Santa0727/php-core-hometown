...
class load extends template
{
    ...
    private function set_front_end_language()
    {
        ...
        if ((bool) \query\main::get_option('allow_select_lang') && isset($_COOKIE['language']) && in_array(strtolower($_COOKIE['language']), array_keys($this->languages))) {
    ...
    public function execute()
    {
        ...
        if ((bool) \query\main::get_option('maintenance') && (!$GLOBALS['me'] || !$GLOBALS['me']->is_subadmin)) {
