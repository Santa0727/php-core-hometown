...
$cities = \query\locations::while_cities( array( 'max' => 0, 'state' => $state, 'show' => 'all', 'orderby' => 'name' ) );
foreach( $cities as $v ) {
...
echo '<div class="row"><span>' . t( 'loc_form_city', "City" ) . ':</span><div><select name="city">';
$cities = \query\locations::while_cities( array( 'max' => 0, 'state' => $info->stateID, 'show' => 'all', 'orderby' => 'name' ) );
foreach( $cities as $v ) {
